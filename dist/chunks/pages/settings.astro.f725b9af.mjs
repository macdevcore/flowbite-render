/* empty css                         */import { c as createAstro, a as createComponent, r as renderTemplate, m as maybeRenderHead, d as addAttribute, s as spreadAttributes, f as renderComponent } from '../astro.67efd1ef.mjs';
import 'html-escaper';
import { a as asset, $ as $$LayoutSidebar } from './404.astro.1c58c656.mjs';
...
const $$ToggleSwitch = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead($$result)}<label${addAttribute(id, "for")}${addAttribute(["relative flex items-center cursor-pointer", clazz], "class:list")}${spreadAttributes(attrs)}>
...
}, "C:/Users/dechm/Dropbox/DevCore/GitHubRepos/flowbite-render/flowbite-render/src/components/ToggleSwitch.astro");

const $$Astro$1 = createAstro("http://localhost:2121");
const $$UserSettings = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$1, $$props, $$slots);
  Astro2.self = $$UserSettings;
  return renderTemplate`${maybeRenderHead($$result)}<div class="grid grid-cols-1 px-4 pt-6 xl:grid-cols-3 xl:gap-4 dark:bg-gray-900">
				...
				<ul class="mb-6 divide-y divide-gray-200 dark:divide-gray-700">
					<li class="py-4">
						<div class="flex justify-between xl:block 2xl:flex align-center 2xl:space-x-4">
							<div class="flex space-x-4 xl:mb-4 2xl:mb-0">
								<div>
									<img class="w-6 h-6 rounded-full"${addAttribute(asset("images/users/bonnie-green.png"), "src")} alt="Bonnie image">
								</div>
								<div class="flex-1 min-w-0">
					...
					<li class="py-4">
						<div class="flex justify-between xl:block 2xl:flex align-center 2xl:space-x-4">
							<div class="flex space-x-4 xl:mb-4 2xl:mb-0">
								<div>
									<img class="w-6 h-6 rounded-full"${addAttribute(asset("images/users/jese-leos.png"), "src")} alt="Jese image">
								</div>
								<div class="flex-1 min-w-0">
									<p class="text-base font-semibold text-gray-900 leading-none truncate mb-0.5 dark:text-white">
										Jese Leos
					...
					<li class="py-4">
						<div class="flex justify-between xl:block 2xl:flex align-center 2xl:space-x-4">
							<div class="flex space-x-4 xl:mb-4 2xl:mb-0">
								<div>
									<img class="w-6 h-6 rounded-full"${addAttribute(asset("images/users/thomas-lean.png"), "src")} alt="Thomas image">
								</div>
								<div class="flex-1 min-w-0">
									<p class="text-base font-semibold text-gray-900 leading-none truncate mb-0.5 dark:text-white">
										Thomas Lean
					...
					<li class="pt-4">
						<div class="flex justify-between xl:block 2xl:flex align-center 2xl:space-x-4">
							<div class="flex space-x-4 xl:mb-4 2xl:mb-0">
								<div>
									<img class="w-6 h-6 rounded-full"${addAttribute(asset("images/users/lana-byrd.png"), "src")} alt="Lana image">
								</div>
								<div class="flex-1 min-w-0">
									<p class="text-base font-semibold text-gray-900 leading-none truncate mb-0.5 dark:text-white">
										Lana Byrd
		...
		<div class="flow-root">
			...
			<div class="divide-y divide-gray-200 dark:divide-gray-700">
				...
				<div class="flex items-center justify-between py-4">
					...
					${renderComponent($$result, "ToggleSwitch", $$ToggleSwitch, { "id": "company-news" })}
				</div>
				<!-- Item 2 -->
				<div class="flex items-center justify-between py-4">
					<div class="flex flex-col flex-grow">
					...
					${renderComponent($$result, "ToggleSwitch", $$ToggleSwitch, { "id": "account-activity", "checked": true })}
				</div>
				<!-- Item 3 -->
				<div class="flex items-center justify-between py-4">
					<div class="flex flex-col flex-grow">
					...
					${renderComponent($$result, "ToggleSwitch", $$ToggleSwitch, { "id": "meetups" })}
				</div>
				<!-- Item 4 -->
				<div class="flex items-center justify-between pt-4">
					...
					${renderComponent($$result, "ToggleSwitch", $$ToggleSwitch, { "id": "new-messages" })}
				</div>
			</div>
			<div class="mt-6">
				<button class="text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Save all</button>
		...
		<div class="flow-root">
			...
			<div class="divide-y divide-gray-200 dark:divide-gray-700">
				...
				<div class="flex items-center justify-between py-4">
					...
					${renderComponent($$result, "ToggleSwitch", $$ToggleSwitch, { "id": "rating-reminders" })}
				</div>
				<!-- Item 2 -->
				<div class="flex items-center justify-between py-4">
					<div class="flex flex-col flex-grow">
					...
					${renderComponent($$result, "ToggleSwitch", $$ToggleSwitch, { "id": "item-update" })}
				</div>
				<!-- Item 3 -->
				<div class="flex items-center justify-between py-4">
					<div class="flex flex-col flex-grow">
					...
					${renderComponent($$result, "ToggleSwitch", $$ToggleSwitch, { "id": "item-comment" })}
				</div>
				<!-- Item 4 -->
				<div class="flex items-center justify-between pt-4">
					<div class="flex flex-col flex-grow">
					...
					${renderComponent($$result, "ToggleSwitch", $$ToggleSwitch, { "id": "buyer-rev" })}
				</div>
			</div>
			<div class="mt-6">
				<button class="text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Save all</button>
...
}, "C:/Users/dechm/Dropbox/DevCore/GitHubRepos/flowbite-render/flowbite-render/src/modules/UserSettings.astro");
...
const $$Settings = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "LayoutSidebar", $$LayoutSidebar, {}, { "default": ($$result2) => renderTemplate`
	${renderComponent($$result2, "UserSettings", $$UserSettings, {})}
` })}`;
}, "C:/Users/dechm/Dropbox/DevCore/GitHubRepos/flowbite-render/flowbite-render/src/pages/settings.astro");

const $$file = "C:/Users/dechm/Dropbox/DevCore/GitHubRepos/flowbite-render/flowbite-render/src/pages/settings.astro";
const $$url = "/settings";
